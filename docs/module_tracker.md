...
| 1.7 | `tests/unit/` — registry + retriever tests | Config validation, collection scoping, drift guard (embedding-model mismatch raises; chunk-param mismatch warns but still returns) | pytest (`tests/unit`) | ⬜ | | |
